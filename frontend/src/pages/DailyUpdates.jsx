        ...
        <div className="dashboard-gradient min-h-screen p-8 md:p-12 font-['Outfit']">
            <div className="max-w-7xl mx-auto space-y-12 pb-20 animate-in fade-in slide-in-from-bottom-8 duration-1000">
                <header className="flex flex-col md:flex-row md:items-end justify-between gap-8">
                    <div>
                        <h1 className="text-5xl font-black text-slate-900 tracking-tight mb-3">Daily Updates</h1>
                        <p className="text-slate-500 font-bold ml-1 text-sm">Track your daily progress and activities.</p>
                    </div>
                    <AnimatePresence>
                        {message && (
                            <motion.div
                                ...
                                className={`px-8 py-5 rounded-[28px] font-black text-xs border shadow-2xl flex items-center space-x-4 ${message.type === 'error' ? 'bg-red-50 border-red-100 text-red-600' : 'bg-emerald-50 border-emerald-100 text-emerald-600'}`}
                            >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div className="glass-strong p-10 md:p-14 rounded-[56px] border-white shadow-2xl h-fit sticky top-28">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-10">
                            <div className="space-y-4">
                                <label className="text-[10px] font-black text-slate-400 ml-4">Work description</label>
                                <textarea
                                    required
                            ...
                            <div className="space-y-4">
                                <label className="text-[10px] font-black text-slate-400 ml-4">Time spent</label>
                            ...
                            <div className="space-y-5">
                                <div className="flex justify-between items-center px-4">
                                    <label className="text-[10px] font-black text-slate-400">Images</label>
                                    <button type="button" onClick={() => handleAddField('images')} className="text-[#92400E] text-[9px] font-black hover:scale-110 transition-transform bg-amber-50 px-4 py-1.5 rounded-full border border-amber-100">+ Add Image</button>
                                </div>
                                <div className="space-y-4">
                            ...
                            <div className="space-y-5">
                                <div className="flex justify-between items-center px-4">
                                    <label className="text-[10px] font-black text-slate-400">Links</label>
                                    <button type="button" onClick={() => handleAddField('links')} className="text-[#92400E] text-[9px] font-black hover:scale-110 transition-transform bg-amber-50 px-4 py-1.5 rounded-full border border-amber-100">+ Add Link</button>
                                </div>
                                <div className="space-y-4">
                            ...
                            >
                                {loading ? (
                                    ...
                                    <>
                                        ...
                                        <span className="text-2xl tracking-tighter">Submit Update</span>
                                    </>
                                )}
                            </button>
                        </form>
                    ...
                    <div className="space-y-10">
                        <div className="flex items-center justify-between px-4">
                            ...
                            <div className="px-4 py-2 bg-white/60 rounded-full border border-white text-[10px] font-black text-slate-400 shadow-sm">
                        ...
                        <div className="space-y-8 max-h-[1200px] overflow-y-auto custom-scrollbar p-2">
                            {updates.length === 0 ? (
                                <div className="py-32 text-center glass rounded-[64px] border-dashed border-2 border-slate-200">
                                    ...
                                    <p className="text-slate-400 font-black text-xs">No updates submitted yet.</p>
                                </div>
                            ) : (
                                    ...
                                    >
                                        ...
                                        <div className="flex justify-between items-start mb-12 relative z-10">
                                            <div className="flex items-center space-x-6">
                                                ...
                                                <div>
                                                    <p className="text-[9px] font-black text-slate-400 ml-1 mb-1">Temporal stamp</p>
                                            ...
                                            <div className="text-right">
                                                <p className="text-[9px] font-black text-slate-400 mb-1">Session duration</p>
                                        ...
                                        <div className="space-y-8 relative z-10">
                                            <div className="bg-white/60 p-8 rounded-[40px] border border-white shadow-inner">
                                                <p className="text-[10px] font-black text-[#92400E] mb-4 flex items-center"><Activity size={14} className="mr-3" /> Work done</p>
                                        ...
                                        {(update.secretaryReply || update.secretaryFeedback) && (
                                            <div className="mt-12 p-10 bg-[#92400E] rounded-[48px] relative overflow-hidden group/feedback">
                                                ...
                                                <p className="text-[10px] font-black text-white/60 mb-6 flex items-center space-x-3">
                                                    <ShieldCheck size={16} />
                                                ...
                                                <div className="mt-8 pt-8 border-t border-white/10 flex items-center justify-between">
                                                    <div className="flex items-center space-x-3 text-white/40">
                                                        <Cpu size={14} />
                                                        <span className="text-[8px] font-black">Feedback Received</span>
                                                    </div>
