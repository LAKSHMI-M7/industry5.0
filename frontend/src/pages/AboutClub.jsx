            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                ...
                <aside className="space-y-10">
                    <section className="bg-white p-10 rounded-[48px] shadow-sm border border-slate-100">
                        <h3 className="text-[10px] font-black text-slate-400 mb-10 flex items-center gap-2">
                        ...
                        <div className="space-y-10">
                            ...
                            <div className="space-y-3">
                                <p className="text-[10px] font-black text-[#92400E]">Chairperson</p>
                                <div className="flex items-center gap-4">
                                    <div className="w-10 h-10 bg-slate-50 rounded-xl flex items-center justify-center border border-slate-100">
                                        <User size={20} className="text-slate-900" />
                                    </div>
                                    <p className="font-black text-slate-900 tracking-tight">{info.chairperson}</p>
                                </div>
                            </div>
                            ...
                            {info.staff.length > 0 && (
                                <div className="space-y-3">
                                    <p className="text-[10px] font-black text-[#92400E]">Staff Coordinators</p>
                                    <div className="space-y-3">
                                        {info.staff.map((s, i) => (
                                            <div key={i} className="flex items-center gap-4 group">
                                                ...
                                                <p className="font-bold text-slate-700 text-sm tracking-tight">{s}</p>
                                            </div>
                                        ))}
                                    </div>
                                </div>
                            ...
                            {/* Secretaries */}
                            <div className="space-y-3">
                                <p className="text-[10px] font-black text-[#92400E]">Secretaries</p>
                                <div className="space-y-3">
                    ...
                    <section className="bg-slate-900 p-10 rounded-[48px] text-white shadow-xl relative overflow-hidden group">
                        ...
                        <h3 className="text-[10px] font-black mb-8 opacity-40">Contact Nexus</h3>
                        <div className="space-y-5">
                            <a href={`mailto:${info.email}`} className="flex items-center gap-4 p-4 bg-white/5 rounded-2xl border border-white/5 hover:bg-white/10 transition-all">
                                ...
                                <span className="text-[10px] font-bold truncate">{info.email}</span>
                            </a>
                            <div className="flex items-center gap-4 p-4 bg-white/5 rounded-2xl border border-white/5">
                                <Instagram size={16} className="text-[#92400E]" />
                                <span className="text-[10px] font-bold truncate">@{info.instagram}</span>
                            </div>
