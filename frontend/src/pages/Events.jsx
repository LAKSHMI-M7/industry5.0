        ...
        <div className="dashboard-gradient min-h-screen p-8 md:p-12 font-['Outfit']">
            <div className="max-w-7xl mx-auto space-y-12 pb-20 animate-in fade-in slide-in-from-bottom-8 duration-1000">
                <header className="flex flex-col md:flex-row md:items-end justify-between gap-8">
                    <div>
                        <h1 className="text-5xl font-black text-slate-900 tracking-tight mb-3 uppercase">Achievement Matrix</h1>
                        <p className="text-slate-500 font-bold ml-1 uppercase tracking-widest text-sm">Scholastic Engagements <span className="text-amber-700">|</span> Institutional Verification</p>
                    </div>
                    <button
                        onClick={() => setShowForm(!showForm)}
                        className="bg-[#92400E] hover:bg-[#78350F] text-white font-black py-5 px-10 rounded-[30px] shadow-2xl shadow-amber-900/30 hover:-translate-y-1.5 active:translate-y-0 transition-all flex items-center space-x-4 group uppercase tracking-widest text-xs"
                    >
                ...
                <AnimatePresence>
                    {message && (
                        <motion.div
                            ...
                            className={`px-8 py-5 rounded-[28px] font-black text-xs uppercase tracking-[3px] border shadow-2xl max-w-2xl mx-auto text-center flex items-center justify-center space-x-4 ${message.type === 'error' ? 'bg-red-50 border-red-100 text-red-600' : 'bg-emerald-50 border-emerald-100 text-emerald-600'}`}
                        >
                ...
                <AnimatePresence mode="wait">
                    {showForm && (
                        ...
                        >
                            ...
                            <h3 className="text-2xl font-black mb-12 flex items-center space-x-5 uppercase tracking-tight text-slate-900">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-12 relative z-10">
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                                    <div className="space-y-4">
                                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-[4px] ml-4">Event Nomenclature</label>
                                        <div className="relative group">
                                            ...
                                            <input
                                                ...
                                                className="w-full bg-white/60 border border-slate-200/60 rounded-[30px] py-4 pl-16 pr-8 focus:bg-white focus:ring-[12px] focus:ring-[#92400E]/5 focus:border-[#92400E] outline-none transition-all text-slate-900 font-black tracking-tight uppercase"
                                                placeholder="SIH 2024..."
                                            />
                                        </div>
                                    </div>
                                    <div className="space-y-4">
                                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-[4px] ml-4">Event Classification</label>
                                        <div className="relative group">
                                    ...
                                    <div className="space-y-4">
                                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-[4px] ml-4">Organizing Body</label>
                                        <div className="relative group">
                                    ...
                                    <div className="space-y-4">
                                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-[4px] ml-4">Engagement Date</label>
                                        <div className="relative group">
                                    ...
                                    <div className="md:col-span-2 space-y-4">
                                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-[4px] ml-4">Achievement Manifest</label>
                                        <div className="relative group">
                                            ...
                                            <input
                                                ...
                                                onChange={handleChange}
                                                className="w-full bg-white/60 border border-slate-200/60 rounded-[30px] py-4 pl-16 pr-8 focus:bg-white focus:ring-[12px] focus:ring-[#92400E]/5 focus:border-[#92400E] outline-none transition-all text-slate-900 font-bold uppercase tracking-tight"
                                ...
                                <div className="bg-white/40 backdrop-blur-md rounded-[40px] p-8 border border-white/60 flex flex-col md:flex-row items-center justify-between gap-8 shadow-inner">
                                    <div className="flex items-center space-x-6">
                                        ...
                                        <div>
                                            <h4 className="font-black text-slate-900 uppercase text-sm tracking-widest">Digital Credential</h4>
                                            <p className="text-[10px] text-slate-500 font-black uppercase tracking-[3px] mt-1">Institutional verification required</p>
                                        </div>
                                    </div>
                                    <button type="button" className="bg-white border border-slate-100 text-slate-900 font-black py-5 px-10 rounded-[24px] hover:bg-slate-50 transition-all flex items-center space-x-4 shadow-xl hover:-translate-y-1 uppercase tracking-widest text-[10px]">
                                ...
                                >
                                    {loading ? (
                                        ...
                                        <>
                                            ...
                                            <span className="text-2xl tracking-tighter uppercase">Authorize Entry to Portfolio</span>
                                        </>
                                    )}
                                </button>
                            </form>
                ...
                <div className="space-y-10">
                    <div className="flex items-center justify-between px-4">
                        ...
                        <div className="px-5 py-2.5 bg-white/60 backdrop-blur-md rounded-full border border-white text-[10px] font-black text-slate-400 uppercase tracking-widest shadow-sm">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                        {events.length === 0 ? (
                            <div className="col-span-full py-32 text-center glass rounded-[64px] border-dashed border-2 border-slate-200">
                                ...
                                <p className="text-slate-400 font-black uppercase tracking-[6px] text-xs">Primary Matrix Synchronized: No Entries</p>
                            </div>
                        ) : (
                                ...
                                >
                                    ...
                                    <div className="flex-grow">
                                        <div className="flex items-center space-x-3 mb-8">
                                            <div className={`px-5 py-2 rounded-2xl text-[9px] font-black uppercase tracking-[3px] shadow-sm transform group-hover:scale-105 transition-transform ${event.type === 'Hackathon' ? 'bg-amber-100/80 text-amber-700 border border-amber-200/50' :
                                            ...
                                            <span className="text-[10px] font-black text-slate-400 tracking-widest uppercase">{new Date(event.date).getFullYear()}</span>
                                        </div>

                                        <h4 className="text-2xl font-black text-slate-900 mb-4 uppercase tracking-tighter leading-tight group-hover:text-[#92400E] transition-colors">{event.eventName}</h4>
                                        ...
                                        <div className="flex items-center space-x-3 mb-8 bg-slate-50/50 p-3 rounded-2xl border border-slate-100/50 w-fit">
                                            ...
                                            <span className="text-[11px] font-black text-slate-500 uppercase tracking-widest">{event.organizer}</span>
                                        </div>
                                    ...
                                    <div className="flex items-center justify-between pt-8 border-t border-slate-50">
                                        <div className="flex items-center space-x-3 text-slate-400">
                                            ...
                                            <span className="text-[10px] font-black uppercase tracking-[3px]">{new Date(event.date).toLocaleDateString(undefined, { day: '2-digit', month: 'short' })}</span>
                                        </div>
                                        <button className="text-[#92400E] font-black text-[10px] uppercase tracking-[4px] hover:scale-105 active:scale-95 transition-all flex items-center space-x-3 bg-amber-50 px-5 py-2.5 rounded-2xl border border-amber-100/50">
                                            <Award size={16} />
