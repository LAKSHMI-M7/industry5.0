...
const seedStudent = async () => {
    try {
        ...
        // User Data with Dual Roles
        const userData = {
            name: 'Lubiga N',
            email: 'lubiganaveen@gmail.com',
            password: 'industry5.0@123',
            role: 'student', // Default role for login
            allowedRoles: ['student', 'secretary'], // Enable role switching
            avatar: '/avatars/lubiga-profile.png'
        };

        const profileData = {
            registerNumber: '210624104103',
            department: 'CSE',
            year: 'II', // 2rd year -> II
            domain: 'App development',
            githubLink: 'https://github.com/Lubiga-N',
            linkedinLink: 'https://www.linkedin.com/in/lubiga-n-ab4522328?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app',
            skills: ['Java', 'SQL']
        };
        ...
        if (user) {
            ...
            user.allowedRoles = userData.allowedRoles; // Update allowed roles
        ...
        console.log('Student/Secretary Lubiga N Seeded Successfully!');
