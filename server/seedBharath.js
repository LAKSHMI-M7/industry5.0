...
const seedStudent = async () => {
    try {
        ...
        const userData = {
            name: 'Bharath K',
            email: 'kothandanbharath@gmail.com',
            password: 'industry5.0@123',
            role: 'student',
            avatar: '/avatars/bharath-profile.png'
        };

        const profileData = {
            registerNumber: '210624205025',
            department: 'Information Technology',
            year: 'II',
            domain: 'App Development',
            githubLink: 'https://github.com/bharathk867',
            linkedinLink: 'https://www.linkedin.com/in/bharath-kothandan-767186327?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app',
            skills: ['HTML', 'CSS', 'Python', 'Dart', 'Flutter']
        };
        ...
        console.log('Student Bharath Seeded Successfully!');
