...
const seedStudent = async () => {
    try {
        ...
        const userData = {
            name: 'Karthikeyan S',
            email: 'karthikeyansivakumar27@gmail.com',
            password: 'industry5.0@123',
            role: 'student',
            avatar: 'https://ui-avatars.com/api/?name=Karthikeyan+S&background=random' // Dynamic avatar
        };

        const profileData = {
            registerNumber: '210623205027',
            department: 'Information Technology',
            year: 'III',
            domain: 'Data Science',
            githubLink: 'https://github.com/karthikeyan272006',
            linkedinLink: 'https://www.linkedin.com/in/karthikeyan-s-45a821364?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app',
            skills: ['Python', 'Advanced SQL', 'Data Visualization (Power BI, Tableau)', 'HTML', 'CSS', 'JavaScript', 'Data Cleaning']
        };
        ...
        console.log('Student Karthikeyan Seeded Successfully!');
