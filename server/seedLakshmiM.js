...
const seedStudent = async () => {
    try {
        ...
        const userData = {
            name: 'Lakshmi.M',
            email: 'lakshmimanikkam789@gmail.com',
            password: 'industry5.0@123',
            role: 'student',
            avatar: '/avatars/lakshmi-m-profile.jpg'
        };

        const profileData = {
            registerNumber: '210624104100',
            department: 'CSE',
            year: 'II',
            domain: 'Web Development',
            githubLink: 'https://github.com/LAKSHMI-M7',
            linkedinLink: 'https://www.linkedin.com/in/lakshmi-m-228760328/',
            skills: ['Python', 'HTML', 'CSS', 'JavaScript(Basic)', 'n8n(AI Tool)']
        };
        ...
        console.log('Student Lakshmi.M Seeded Successfully!');
