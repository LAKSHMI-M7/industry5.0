...
const seedStudent = async () => {
    try {
        ...
        const userData = {
            ...
            email: 'vijayalakshmisettu15@gmail.com',
            password: 'industry5.0@123',
            role: 'student',
            avatar: '/avatars/vijayalakshmi-profile.png'
        };

        const profileData = {
            registerNumber: '210624205162',
            department: 'Information Technology',
            year: 'II',
            domain: 'Cloud computing',
            githubLink: 'https://github.com/vijayalakshmisettu15-sketch',
            linkedinLink: 'https://www.linkedin.com/in/vijayalakshmi-s-987664328?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app',
            skills: ['Python', 'Java(basics)', 'Html']
        };
        ...
        console.log('Student Vijayalakshmi Seeded Successfully!');
