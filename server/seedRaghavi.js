...
const seedStudent = async () => {
    try {
        ...
        const userData = {
            name: 'Raghavi. M',
            email: 'mraghavimohan@gmail.com',
            password: 'industry5.0@123',
            role: 'student',
            avatar: '/avatars/raghavi-profile.jpg'
        };

        const profileData = {
            registerNumber: '210624205111',
            department: 'Information Technology - "B"',
            year: 'II',
            domain: 'Web development',
            githubLink: 'https://github.com/mraghavimohan-cpu',
            linkedinLink: 'https://www.linkedin.com/in/raghavi-mohan-b45010328?utm_source=share_via&utm_content=profile&utm_medium=member_android',
        ...
        console.log('Student Raghavi Seeded Successfully!');
