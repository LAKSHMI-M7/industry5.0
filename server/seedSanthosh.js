...
const seedStudent = async () => {
    try {
        ...
        const userData = {
            ...
            email: 'santhoshsandy909248@gmail.com',
            password: 'industry5.0@123',
            role: 'student',
            avatar: '/avatars/santhosh-profile.png'
        };

        const profileData = {
            registerNumber: '210624205127',
            department: 'Information Technology - "C"',
            year: 'II',
            domain: 'UI/UX',
            githubLink: 'https://github.com/Santho-008',
            linkedinLink: 'https://www.linkedin.com/in/santhosh-kumar-p-763934305?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app',
        ...
        console.log('Student Santhosh Seeded Successfully!');
